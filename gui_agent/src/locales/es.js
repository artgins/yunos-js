...
const es = {
    ...
    translation: {
        ...
        "interrupt (ctrl+c)": "Interrumpir (ctrl+c)",
        "pipe": "Barra vertical",
        "slash": "Barra",
        "hyphen": "Guion",
        ...
        "end key": "Tecla Fin",
        "show the keyboard": "Mostrar el teclado",
        "escape key": "Tecla Escape",
        "tab key": "Tecla Tabulador",
        ...
        "asset not available":        "Archivo no disponible",
        ...
        "the schemas shown may be out of date: they are read again, and the form opens again on them with your changes": "Los esquemas que se muestran pueden estar desfasados: se están volviendo a leer, y el formulario se abre otra vez sobre ellos con tus cambios",
        "the schemas were read again and what the form was editing is not there any more": "Los esquemas se han vuelto a leer, y lo que editaba el formulario ya no está",
        "apply waits for the save": "Aplicar espera a que termine el guardado en curso",
        "the saved schemas changed: open apply again": "Los esquemas guardados han cambiado: abre Aplicar otra vez para ver lo que instala",
        "the tab is busy: open apply again when it is ready": "La pestaña está ocupada: abre Aplicar otra vez cuando esté lista",
        "the import plan is gone: preview it again": "El plan de importación ya no está: vuelve a previsualizarlo",
        "schema as c source": "El esquema como código C",
        "schema as json": "El esquema como JSON",
        "the treedb did not describe a write back: the writes after it were not sent": "La treedb no ha devuelto lo que escribió: las escrituras siguientes no se han enviado. El esquema se vuelve a leer",
        ...
        "more than one main topic": "Hay más de un topic marcado como principal",
        "main topic not hooked to itself": "El topic principal no tiene hook a sí mismo",
        ...
        "schema imposed by the binary": "El esquema lo impone el binario (impose_c_schema): guardar y exportar sí, aplicar no",
        "nothing saved to apply": "Nada guardado que aplicar",
        "relaunched yuno": "Yuno que se relanza",
        "schema changes": "Cambios",
        "unsaved schema changes: save to publish them": "Cambios del esquema sin guardar: guarda para publicarlos",
        "unsaved changes: save first, so the literal carries the versions that publish it": "Cambios sin guardar: guarda primero, para que el literal lleve las versiones que lo publican",
