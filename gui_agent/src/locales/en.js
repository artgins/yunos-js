...
const en = {
    ...
    translation: {
        ...
        "show":                                         "Show",
        "view":                                         "View",
        /*  The Developer window (yui_dev.js) -- see the note in es.js.  */
        "automata":                                     "Automata",
        "both":                                         "Both",
        "creation":                                     "Creation",
        "data":                                         "Data",
        ...
        "show linked records":        "Show linked records",
        "show file":                  "Show file",
        "open in a new tab":          "Open in a new tab",
        "asset not available":        "File not available",
        ...
        "the schemas shown may be out of date: they are read again, and the form opens again on them with your changes": "The schemas shown may be out of date: they are being read again, and the form opens again on them with your changes",
        "the schemas were read again and what the form was editing is not there any more": "The schemas were read again, and what the form was editing is not there any more",
        "apply waits for the save": "Apply waits for the save in flight to end",
        "the saved schemas changed: open apply again": "The saved schemas changed: open Apply again to see what it installs",
        "the tab is busy: open apply again when it is ready": "The tab is busy: open Apply again when it is ready",
        "the import plan is gone: preview it again": "The import plan is gone: preview it again",
        "schema as c source": "The schema as C source",
        "schema as json": "The schema as JSON",
        "the treedb did not describe a write back: the writes after it were not sent": "The treedb did not describe a write back: the writes after it were not sent. The schema is read again",
        ...
        "more than one main topic": "More than one topic is marked as the main one",
        "main topic not hooked to itself": "The main topic is not hooked to itself",
        ...
        "differences unanswered": "The node's agent did not answer diff-schema for the owners below: the report shows only what the others said. Owners:",
        ...
        "the draft is the schema in use, its saved schema was withdrawn": "Nothing to save: the draft is the schema in use, so the saved schema that differed from it was withdrawn. Nothing is left to apply in:",
        ...
        "schema imposed by the binary": "The schema is imposed by the binary (impose_c_schema): save and export work, apply does not",
        "nothing saved to apply": "Nothing saved to apply",
        "relaunched yuno": "Yuno that is relaunched",
        "schema changes": "Changes",
        "unsaved schema changes: save to publish them": "Unsaved schema changes: save to publish them",
        "unsaved changes: save first, so the literal carries the versions that publish it": "Unsaved changes: save first, so the literal carries the versions that publish it",
        ...
        "radius": "Radius",
        "this port": "This port",
        "same port in topic": "Same port in topic",
        "all ports": "All ports",
        "apply to": "Apply to",
        ...
        "collapsed in the source": "Collapsed in the source: a pasted document has nowhere to fetch it from",
        ...
        "compare needs two json": "Put a JSON in each pane to compare them",
