...
import {register_c_treedb_connections} from "./c_treedb_connections.js";
import {register_c_treedb_preferences} from "./c_treedb_preferences.js";
...
function main()
{
    ...
    register_c_treedb_connections();
    register_c_treedb_preferences();
