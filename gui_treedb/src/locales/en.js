...
const en = {
    ...
    translation: {
        ...
        "connections help": "Edit cells inline. Each URL points at a node's agent; scan a row to pick the node services to browse.",
        "backend not connected": "Backend not connected",

        /* node scan + tranger records browser (added 2026-07-11) */
        "no services declared": "No services declared — add or scan them in Settings",
        "scan node services": "Scan the node services",
        "scanning": "Scanning…",
        "scan failed": "Scan failed",
        "scan timeout": "Scan timeout",
        "connection closed": "Connection closed",
        "list-yunos failed": "list-yunos failed",
