...
const es = {
    ...
    translation: {
        ...
        "connections help": "Edita las celdas en línea. Cada URL apunta al agente de un nodo; escanea una fila para elegir los servicios del nodo a explorar.",
        "backend not connected": "Backend no conectado",

        /* node scan + tranger records browser (added 2026-07-11) */
        "no services declared": "No hay servicios declarados — añádelos o escanéalos en Ajustes",
        "scan node services": "Escanear los servicios del nodo",
        "scanning": "Escaneando…",
        "scan failed": "Escaneo fallido",
        "scan timeout": "Escaneo agotado (timeout)",
        "connection closed": "Conexión cerrada",
        "list-yunos failed": "list-yunos falló",
